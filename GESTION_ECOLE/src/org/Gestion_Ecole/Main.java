...
import org.Gestion_Ecole.Manager.GestionClasses;
import org.Gestion_Ecole.Manager.GestionEtudiants;
import org.Gestion_Ecole.Manager.GestionMatieres;
import org.Gestion_Ecole.Manager.GestionNotes;
...
public class Main {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            try {
                ...
                scanner.nextLine();  //  ramène à la ligne
                switch (choix) {
                    case 1:
    ...
    private static void ajouterEtudiant(Scanner scanner) {
        ...
        // Recupere l' etudiant de la classe
